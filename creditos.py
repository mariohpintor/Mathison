...
class Creditos:
	...
	def run(self):
		...
		yo_rect = yo.get_rect(center=(screen_width/2,screen_height/2-350))
		zeleny_rect = zeleny.get_rect(center=(screen_width/2,screen_height/2-200))
		facultad_rect = facultad.get_rect(center=(screen_width/2,screen_height/2-50))
		correo1_rect = correo1.get_rect(center=(screen_width/2,screen_height/2+100))
		correo2_rect = correo2.get_rect(center=(screen_width/2,screen_height/2+250))
