...
class UI():
	def __init__(self, surface):
		...
		self.health_bar = pygame.image.load('../clear_code/graphics/ui/health_bar.png').convert_alpha()
		self.coin = pygame.image.load('../clear_code/graphics/ui/coin.png').convert_alpha()
